...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1f16e852d16e80ac9d57dd9e0fa74c7b,en:1f16e852d16e80ac9d57dd9e0fa74c7b',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Baoxing', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Beyond Ignorance（越过无知，触摸真知。）', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.zhangbaoxing.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'zhangbaoxing, baoxing, Baoxing', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_WEIXIN: process.env.NEXT_PUBLIC_CONTACT_WEIXIN || 'https://www.baidu.com', // weixin
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twiikoo-preiview.vercel.app/', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
